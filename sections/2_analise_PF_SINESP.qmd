...
Utilizando o teste Mann-Kendall, temos evidências que indicam não tendência, ou seja, o número de apreenções de maconha está estável ao longo do tempo.
...
Utilizando o teste Mann-Kendall, teste esse que verifica se uma série temporal possui tendência, temos evidências que indicam tendência, ou seja, o número de apreenções de cocaína está subindo ao longo do tempo.
...
Utilizando o teste Mann-Kendall, teste esse que verifica se uma série temporal possui tendência, temos evidências que indicam não tendência, ou seja, o número de apreenções está estável ao longo do tempo.
