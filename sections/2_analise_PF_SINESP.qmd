...
highchart() |>
  ...
  hc_caption(text = "Gráfico 4 - Frenquência anual de apreensões de drogas por item para os anos de 2014 a 2023")
```
...
highchart() |>
  ...
  hc_caption(text = "Gráfico 5 - Quantidade anual de apreensões de drogas por item para os anos de 2014 a 2023")
```
...
highchart() |>
  ...
  hc_caption(text = "Gráfico 6 - Quantidade anual de apreensões de drogas por regiões do Espírito Santo para os anos de 2014 a 2023")
```
...
highchart() |>
  ...
  hc_caption(text = "Gráfico 7 - Quantidade anual de apreensões de drogas para os anos de 2014 a 2023")
```
...
highchart() |>
  ...
  hc_colors(viridis::viridis(4)) |>
  hc_caption(text = "Gráfico 8 - Total peso mensal de drogas apreendidas para os meses entre 01/01/2018 e 01/12/2023")
```
...
highchart() |>
  ...
  hc_caption(text = "Gráfico 9 - Total mensal de drogas apreendidas para os meses entre 01/01/2018 e 01/12/2023")
```
...
highchart() %>%
  ...
  hc_caption(text = "Gráfico 10 - Decomposição STL para o total peso mensal de drogas apreendidas (Maconha)")
```
...
highchart() %>%
  ...
  hc_legend(enabled = TRUE) %>%
  hc_colors(viridis::viridis(10, direction = -1, option = "A")[c(3,5,7,9)]) |>
  hc_caption(text = "Gráfico 11 - Decomposição STL para o total peso mensal de drogas apreendidas (Cocaína)")
```
...
highchart() %>%
  ...
  hc_legend(enabled = TRUE) %>%
  hc_colors(viridis::viridis(10, direction = -1, option = "A")[c(3,5,7,9)]) |>
  hc_caption(text = "Gráfico 12 - Decomposição STL para o total mensal de drogas apreendidas (Tráfico)")
```
