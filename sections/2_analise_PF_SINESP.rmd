...
O gráfico 13 mostra um aumento progressivo nas quantidades anuais apreendidas ao longo dos anos, com a maconha e a cocaína como as substâncias de maior volume. Destaca-se em 2022 a apreensão de 3.715 kg de maconha e 1.681 kg de cocaína.
...
O gráfico 14 apresenta a distribuição das apreensões por regiões do Espírito Santo, evidenciando diferenças significativas entre os grupos regionais. A região Central e Litoral responde pela grande maioria das apreensões, um padrão que pode ser observado consistentemente nos dados.
...
O gráfico 15 apresenta o volume total de apreensões (em gramas) realizadas pela Polícia Federal do Espírito Santo entre 2014 e 2023.
...
Para o gráfico 18, a componente sazonal mostra picos recorrentes em Maio. Utilizando o teste de Mann-Kendall, não há evidências que indiquem tendência, ou seja, o número de apreensões de maconha está estável ao longo do tempo.
...
Para o gráfico 19, a componente sazonal mostra picos recorrentes em Junho. Utilizando o teste de Mann-Kendall, temos evidências que indicam tendência, ou seja, o número de apreensões de cocaína está subindo ao longo do tempo. Analisando graficamente, pode-se notar a tendência oscilante porém crescente, corroborando com o resultado do teste de Mann-Kendall.
...
Para o gráfico 20, a componente sazonal mostra picos recorrentes em Julho. Utilizando o teste de Mann-Kendall, não há evidências que indiquem tendência, ou seja, o número de apreensões está estável ao longo do tempo.
