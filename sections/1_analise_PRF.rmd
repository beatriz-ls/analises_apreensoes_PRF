...
ggplot() +
  ...
  labs(title = "Hotspot de Apreensões no Espírito Santo",
       ...
       caption = "Gráfico 6 - Hotspot de Apreensões no Espírito Santo",
       x = "Longitude", y = "Latitude") +
  theme_minimal()

```

Analisando o gráfico 6, percebem-se três áreas principais de aglomeração de ocorrência, região ao sul do estado, região próxima a Grande Vitória e área ao norte do estado.
